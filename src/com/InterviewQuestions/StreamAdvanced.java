...
public class StreamAdvanced {
	...
	public static void main(String[] args) {
		...
		empList.add(new Employee2(101, "siva", 1,"Security", "active", 2000));
		empList.add(new Employee2(102, "reddy", 2,"HR", "inactive", 4000));
		empList.add(new Employee2(103, "raju", 2,"HR", "active", 6000));
		empList.add(new Employee2(104, "babu", 3,"Transport", "inactive", 3500));
		empList.add(new Employee2(105, "sai", 4,"Transport", "active", 5000));
		empList.add(new Employee2(106, "jagdish", 4,"Security", "active", 5000));
		empList.add(new Employee2(107, "yeswanth", 4,"Security", "active", 5000));
		...
		Map<Integer, Optional<Employee2>> topSlaryInEachDept = empList.stream().collect(Collectors.groupingBy(Employee2::getDeptId, Collectors.maxBy(Comparator.comparing(Employee2::getSalary))));

		topSlaryInEachDept.entrySet().forEach(entry -> {
			System.out.println("dept " + entry.getKey() + " top emp is " + entry.getValue().get());
		});
